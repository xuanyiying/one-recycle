...
export default function OrderSuccess({ orderNumber, onComplete }: OrderSuccessProps) {
    /**
    ...
    const handleViewOrder = () => {
        Taro.navigateTo({
            ...
            fail: () => {
                // Fallback if orders page doesn't exist
                Taro.showToast({
                    title: '页面不存在',
                    icon: 'none',
                })
            ...
            <View className='order-success-container'>
                ...
                <View className='order-number-section'>
                    ...
                    <View className='order-number-card'>
                        <Text className='order-number-value'>{orderNumber}</Text>
                        <Button className='btn-copy' onClick={handleCopyOrderNumber}>
                            复制
                        </Button>
                    </View>
                </View>
