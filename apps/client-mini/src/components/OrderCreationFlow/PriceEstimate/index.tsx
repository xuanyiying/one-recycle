...
export default function PriceEstimate({
    ...
    // Fetch pricing from API when items change
    useEffect(() => {
        ...
        if (useAPI) {
            ...
            const fetchPricing = async () => {
                ...
                try {
                    ...
                    // Fall back to local calculation on API error
                    console.warn('[PriceEstimate] API estimation failed, using local calculation:', err)
                    const localPricing = calculateOrderPricing(items)
