...
describe('TimeSlotService', () => {
    ...
    describe('fetchAvailableTimeSlots', () => {
        ...
        it('should normalize grouped day slots response', async () => {
            vi.mocked(requestUtils.get).mockResolvedValueOnce({
                success: true,
                data: [
                    {
                        date: '2026-02-05',
                        slots: [
                            { startTime: '09:00', endTime: '11:00', isAvailable: true, quota: 5, remaining: 1 },
                        ],
                    },
                    {
                        date: '2026-02-06',
                        slots: [
                            { startTime: '11:00', endTime: '13:00', isAvailable: true, quota: 5, remaining: 5 },
                        ],
                    },
                ],
            })

            const result = await fetchAvailableTimeSlots('2026-02-05', 'addr_123')
    ...
    describe('fetchTimeSlotsBatch', () => {
        ...
        it('should normalize grouped batch response', async () => {
            vi.mocked(requestUtils.get).mockResolvedValueOnce({
                success: true,
                data: [
                    {
            ...
            const result = await fetchTimeSlotsBatch('2026-02-05', 2, 'addr_123')
