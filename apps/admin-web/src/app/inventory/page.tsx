    ...
    async (params: InventoryQueryParams = {}) => {
      try {
        ...
        const response: InventoryListResponse =
          await inventoryService.getInventoryItems(queryParams);
        ...
        <Content style={{ padding: 24, margin: 0, minHeight: 280 }}>
          ...
          {activeTab === 'adjustments' && (
            <>
              <div style={{ marginBottom: 16 }}>
                <Space>
                  <Button onClick={() => setActiveTab('items')}>返回库存管理</Button>
                  <Button icon={<ReloadOutlined />} onClick={handleRefresh}>
                    刷新
                  </Button>
                </Space>
              ...
              <Spin spinning={loading}>
                <Table columns={adjustmentColumns} dataSource={adjustments} pagination={false} />
              </Spin>
            </>
          )}
            ...
            <Form form={form} layout="vertical">
              ...
              <Row gutter={16}>
                <Col span={12}>
                  ...
                  >
                    <InputNumber min={0} style={{ width: '100%' }} placeholder="请输入最小阈值" />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  <Form.Item
                  ...
                  >
                    <InputNumber min={0} style={{ width: '100%' }} placeholder="请输入最大阈值" />
                  </Form.Item>
                </Col>
              </Row>
