  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
        ...
        <Col xs={24} lg={12}>
          <Card title="库存预警" extra={<WarningOutlined style={{ color: '#ff4d4f' }} />}>
            {inventoryAlerts.length > 0 ? (
                ...
                renderItem={(item) => (
                  <List.Item>
                    <List.Item.Meta
                      ...
                      description={
                        <Space>
                          <Text type="secondary">当前库存: {item.currentStock}</Text>
                          <Text type="secondary">最低库存: {item.minStock}</Text>
              ...
              <Alert message="库存充足" description="所有商品库存正常" type="success" showIcon />
            )}
          </Card>
        </Col>
      </Row>
