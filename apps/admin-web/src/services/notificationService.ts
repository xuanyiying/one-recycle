...
export class NotificationService {
    ...
    // 获取通知列表
    async getNotifications(params: NotificationQueryParams = {}, useCache: boolean = true): Promise<NotificationListResponse> {
    ...
    private async fetchNotifications(params: NotificationQueryParams): Promise<NotificationListResponse> {
    ...
    // 从模板创建通知
    async createFromTemplate(templateId: string, data: Partial<CreateNotificationRequest>): Promise<Notification> {
    ...
    // 测试发送通知
    async testSendNotification(data: CreateNotificationRequest, testRecipients: string[]): Promise<void> {
