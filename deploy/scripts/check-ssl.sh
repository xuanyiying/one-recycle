...
echo "   - Ensure DNSPod API credentials are configured correctly"
echo ""
...
echo "   docker restart one-recycle-certbot"
echo "   # Then inspect logs for DNS-01 validation:"
echo "   docker logs --tail 100 one-recycle-certbot"
echo ""
