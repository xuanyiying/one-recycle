...
export default registerAs(
  ...
  (): PaymentConfig => ({
    ...
    wechatPayGatewayUrl: process.env.WECHAT_PAY_GATEWAY_URL || 'https://api.mch.weixin.qq.com',
    callbackBaseUrl: process.env.PAYMENT_CALLBACK_URL || 'http://localhost:3001',
  }),
);
